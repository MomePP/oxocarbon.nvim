...
(custom-set-face! :SnacksPickerPreview [] {:bg oxocarbon.none :blend winblend})
(custom-set-face! :SnacksPickerPreviewBorder [] {:bg oxocarbon.none :blend winblend})
(custom-set-face! :SnacksPickerPreviewTitle [:bold] {:fg oxocarbon.float_bg :bg oxocarbon.base10 :blend winblend})
(custom-set-face! :SnacksPickerInput [] {:bg oxocarbon.blend :blend winblend})
(custom-set-face! :SnacksPickerInputBorder [] {:bg oxocarbon.blend :blend winblend})
(custom-set-face! :SnacksPickerList [] {:bg oxocarbon.blend :blend winblend})
(custom-set-face! :SnacksPickerListBorder [] {:bg oxocarbon.blend :blend winblend})
...
(custom-set-face! :MarkSignNumHL [:bold] {:fg oxocarbon.base11})
...
(custom-set-face! :MatchParen [] {:fg oxocarbon.none :bg oxocarbon.base02})
...
(custom-set-face! :Whitespace [] {:fg (blend-hex base00 base06 0.14) :bg oxocarbon.none})
...
(custom-set-face! :markdownH1 [] {:fg oxocarbon.red :bg oxocarbon.none})
(custom-set-face! :markdownH2 [] {:fg oxocarbon.orange :bg oxocarbon.none})
(custom-set-face! :markdownH3 [] {:fg oxocarbon.yellow :bg oxocarbon.none})
(custom-set-face! :markdownH4 [] {:fg oxocarbon.green :bg oxocarbon.none})
(custom-set-face! :markdownH5 [] {:fg oxocarbon.blue :bg oxocarbon.none})
(custom-set-face! :markdownH6 [] {:fg oxocarbon.periwinkle :bg oxocarbon.none})
(custom-set-face! :markdownH7 [] {:fg oxocarbon.lavender :bg oxocarbon.none})
(custom-set-face! :markdownH8 [] {:fg oxocarbon.indigo :bg oxocarbon.none})
...
(custom-set-face! "@markup.heading.2.markdown" [] {:link "markdownH2"})
(custom-set-face! "@markup.heading.3.markdown" [] {:link "markdownH3"})
(custom-set-face! "@markup.heading.4.markdown" [] {:link "markdownH4"})
(custom-set-face! "@markup.heading.5.markdown" [] {:link "markdownH5"})
(custom-set-face! "@markup.heading.6.markdown" [] {:link "markdownH6"})
(custom-set-face! "@markup.heading.7.markdown" [] {:link "markdownH7"})
(custom-set-face! "@markup.heading.8.markdown" [] {:link "markdownH8"})
