...
vim.api.nvim_set_hl(0, "SnacksPicker", {bg = oxocarbon.float_bg})
vim.api.nvim_set_hl(0, "SnacksPickerBorder", {bg = oxocarbon.float_bg})
vim.api.nvim_set_hl(0, "SnacksPickerTitle", {fg = oxocarbon.float_bg, bg = oxocarbon.base12, bold = true})
vim.api.nvim_set_hl(0, "SnacksPickerPreview", {bg = oxocarbon.base00})
vim.api.nvim_set_hl(0, "SnacksPickerPreviewBorder", {bg = oxocarbon.base00})
vim.api.nvim_set_hl(0, "SnacksPickerPreviewTitle", {fg = oxocarbon.base00, bg = oxocarbon.base10, bold = true})
...
vim.api.nvim_set_hl(0, "TreesitterContext", {bg = oxocarbon.none, bold = true, blend = 0})
...
vim.api.nvim_set_hl(0, "LspReferenceText", {fg = oxocarbon.none, bg = oxocarbon.base02})
vim.api.nvim_set_hl(0, "LspReferenceread", {fg = oxocarbon.none, bg = oxocarbon.base02})
vim.api.nvim_set_hl(0, "LspReferenceWrite", {fg = oxocarbon.none, bg = oxocarbon.base02})
...
vim.api.nvim_set_hl(0, "@markup.heading.1.markdown", {fg = oxocarbon.pink})
vim.api.nvim_set_hl(0, "@markup.heading.2.markdown", {fg = oxocarbon.orange})
vim.api.nvim_set_hl(0, "@markup.heading.3.markdown", {fg = oxocarbon.yellow})
vim.api.nvim_set_hl(0, "@markup.heading.4.markdown", {fg = oxocarbon.green})
vim.api.nvim_set_hl(0, "@markup.heading.5.markdown", {fg = oxocarbon.blue})
vim.api.nvim_set_hl(0, "@markup.heading.6.markdown", {fg = oxocarbon.periwinkle})
vim.api.nvim_set_hl(0, "@markup.heading.7.markdown", {fg = oxocarbon.lavender})
...
vim.api.nvim_set_hl(0, "BlinkCmpItemAbbrDeprecated", {fg = oxocarbon.base03, bg = oxocarbon.none, strikethrough = true})
vim.api.nvim_set_hl(0, "BlinkCmpItemAbbrMatch", {fg = oxocarbon.base05, bg = oxocarbon.none, bold = true})
vim.api.nvim_set_hl(0, "BlinkCmpItemAbbrMatchFuzzy", {fg = oxocarbon.base05, bg = oxocarbon.none, bold = true})
vim.api.nvim_set_hl(0, "BlinkCmpItemMenu", {fg = oxocarbon.base10, bg = oxocarbon.none, italic = true})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindInterface", {fg = oxocarbon.base08, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindColor", {fg = oxocarbon.base08, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindTypeParameter", {fg = oxocarbon.base08, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindText", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindEnum", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindKeyword", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindConstant", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindConstructor", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindReference", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindFunction", {fg = oxocarbon.base11, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindStruct", {fg = oxocarbon.base11, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindClass", {fg = oxocarbon.base11, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindModule", {fg = oxocarbon.base11, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindOperator", {fg = oxocarbon.base11, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindField", {fg = oxocarbon.base12, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindProperty", {fg = oxocarbon.base12, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindEvent", {fg = oxocarbon.base12, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindUnit", {fg = oxocarbon.base13, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindSnippet", {fg = oxocarbon.base13, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindFolder", {fg = oxocarbon.base13, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindVariable", {fg = oxocarbon.base14, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindFile", {fg = oxocarbon.base14, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindMethod", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindValue", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpItemKindEnumMember", {fg = oxocarbon.base15, bg = oxocarbon.none})
